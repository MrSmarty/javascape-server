...
public abstract class SensorBase {
    ...
    /**
     * The index of the sensor on the device. Digital starts at 0 and goes to the
     * number of digital pins - 1. Analog starts at 0 and goes to the number of
     * analog pins - 1.
     */
    public int index;
     ...
     * <p>
     * Sensors can be renamed using the {@link #setName(String)} method. The default
     * for this value should be the name of the Sensor.
     */
    ...
    /**
     * Adds a value to the list of values. If the list is full, the oldest value is
     * removed.
     * <p>
